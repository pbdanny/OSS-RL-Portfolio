...
plot(roc_perf, colorize = TRUE, print.cutoffs.at = seq(0, 0.7, 0.01))

rm(list = c('pred_prop', 'roc_pred', 'roc_pref'))
```
From ROC curve use probability threshold = 0.04 as cut off points
...
table(test$d36_flag, pred_class)
```
    Since the effect of correctly predict d36 higher than falsely predict then choose the threshold at *0.03*. Sensitivity (True positive rate) = 163/(163+21) = 88.58% , specificity (Ture negative rate) = 2260/(3362+3237) = 41.11%