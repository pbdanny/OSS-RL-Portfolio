...
logit_1 <- glm(d36_flag ~ monthly_salary, data = train, family = 'binomial')

pred <- predict(logit_1, newdata = test, type = 'response')
# choose threshold use ROCR Curve
library(ROCR)
...
table(test$d36_flag, pred >= 0.02)
```

The logit model accuracy = (0+5160)/(5160+337+184+0) = 0.9082
